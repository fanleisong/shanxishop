...
module.exports = class extends think.Service {
  async login(code, fullUserInfo) {
    try {
      ...
      // 解析用户数据
      const wechatUserInfo = await this.decryptUserInfoData(sessionData.openid,sessionData.session_key, fullUserInfo.encryptedData, fullUserInfo.iv);
   ...
   */
  async decryptUserInfoData(openid,sessionKey, encryptedData, iv) {
    let decoded = '';
    try {
